...
"[project]/app/training/free-throw/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FreeThrowPage() {
    ...
    const onSegmentHit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$1_$40$babel$2b$core$40$7$2e$28$2e$5_$40$playwright$2b$test$40$1$2e$56$2e$1_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FreeThrowPage.useCallback[onSegmentHit]": (segment)=>{
            const hitId = `${Date.now()}-${Math.random()}`;
            setGameState({
                "FreeThrowPage.useCallback[onSegmentHit]": (prev)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$training$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["processFreeThrowHit"])(prev, segment, hitId)
            }["FreeThrowPage.useCallback[onSegmentHit]"]);
        }
    }["FreeThrowPage.useCallback[onSegmentHit]"], []);
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$training$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFreeThrowStats"])(gameState);
    const lastHits = gameState.hits.slice(-10).reverse();
    const handleReset = ()=>{
        setGameState((0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$training$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createFreeThrowState"])());
    };
...
_s(FreeThrowPage, "86L2MQIhGBagUNnkqdMdOzMnpMw=", false, function() {
    return [
...
_c = FreeThrowPage;
var _c;
__turbopack_context__.k.register(_c, "FreeThrowPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_6bdfcb6f._.js.map